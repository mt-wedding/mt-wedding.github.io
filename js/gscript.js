...
var invitation_start_en = "Trúc My & Thành Thông cordially invite";
      invitation_end_en = "to our wedding party.";
    invitation_start_vi = "Trúc My & Thành Thông thân mời";
...
function setInvitation(name_en, name_vi, defaultlang, vi_pronoun="") {
  ...
  if (name_vi=="" && defaultlang=="vi") {
    document.getElementById("guest_invitation_vi").innerHTML = "Trúc My và Thành Thông Kính Mời Quý Khách Dự Tiệc Cưới Của Chúng Con.";
  }
  else if (name_en=="" && defaultlang=="en") {
    document.getElementById("guest_invitation_en").innerHTML = "Trúc My & Thành Thông Cordially Invite You To Our Wedding Party.";
  }
  else if (vi_pronoun=="") {
